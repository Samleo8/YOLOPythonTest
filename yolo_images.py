...
ap.add_argument("-g","--cfg", default="cfg",
	help="Folder containing cfg and weight files")
ap.add_argument("-y","--yoloVersion", default="3",
	help="yoloVersion: 2 | 3 | 3-tiny")
ap.add_argument("-c", "--confidence", type=float, default=0.5,
	help="minimum probability to filter weak detections")
ap.add_argument("-t", "--threshold", type=float, default=0.3,
	help="threshold when applying non-maxima suppression (NMS)")
